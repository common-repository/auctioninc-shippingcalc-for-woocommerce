        ...
        if ($this->account_id) {
            ...
            if (!empty($package['destination']['country'])) {
                ...
                foreach ($package['contents'] as $item_id => $values) {
                    ...
                    if ($values['data']->get_type() == 'variation' && !empty($values['data']->post->post_parent)) {
                        // For variable products, need to get additional shipping info for 'variation' from parent product
                        $product_id = $values['data']->post->post_parent;
                    }
